...
- [ ] add the ability to switch between light and dark display modes. default should follow whatever the OS has set.
...
- [x] in windows when set as the default pdf reader, double-clicking a pdf opens the app but did not load the file.
